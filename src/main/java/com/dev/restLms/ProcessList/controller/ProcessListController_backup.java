...
//         // System.out.println("사용자 세션아이디 : "+userPermissionGroup);
...
//             // System.out.println("사용자 권한에 대한 권한 그룹 아이디"+permissionGroupUuid2);
...
//                 System.out.println("사용자 권한에 대한 권한 그룹 명 : "+permissionGroupName);

//                 // 사용자의 세션아이디에 대한 권한 명이 STUDENT인지 확인
//                 if(permissionGroupName.equals("STUDENT")){

//                     Optional<ProcessListUserOwnCourse> processListUserOwnCourse = processListUserOwnCourseRepository.findByCourseIdAndSessionId(courseId, sessionId);

//                     String userApproval = processListUserOwnCourse.get().getCourseApproval();

//                     if(processListUserOwnCourse.isEmpty() || userApproval.equals("T")){
...
//         }
//         else{
//             return ResponseEntity.badRequest().body("수강신청 권한이 없습니다");
//         }
//     }
// }
