...
//     @GetMapping()
//     public ResponseEntity<?> getAllUserSubjects(@RequestParam String sessionId) {

//         // 사용자의 수강중인 과목 확인 
//         List<userSubjectsUserOwnAssignment> userOwnAssignments = userSubjectsUserOwnAssignmentRepository.findByUserSessionIdAndSubjectAcceptCategory(sessionId, "T");
...
//             // 수강 중인 과목 중 과정에 속하지 않은 과목만 확인
//             if(userOwnAssignment.getSubjectAcceptCategory().equals("T")){
...
//                 // 수료한 영상 / 영상 수 * 100
//                 int subjectCompletionPercent = (subjectCompletion/userOwnAssignments.size())*100;
