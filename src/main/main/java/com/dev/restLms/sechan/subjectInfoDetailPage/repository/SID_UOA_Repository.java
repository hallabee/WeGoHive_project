...
public interface SID_UOA_Repository extends JpaRepository<UserOwnAssignment, String> {
    ...
    Optional<UserOwnAssignment> findByUserSessionIdAndOfferedSubjectsIdAndSubjectAcceptCategory(
        String userSessionId, String offeredSubjectsId, String subjectAcceptCategory);
}
